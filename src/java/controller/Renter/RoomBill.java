 ...
 * @author ASUS
 */
@WebServlet(name = "RoomBill", urlPatterns = {"/roombill"})
public class RoomBill extends HttpServlet {
...
int id = 1;
        ...
        request.getRequestDispatcher("/Renter/roombill.jsp").forward(request, response);
