                                                                        ...
                                                                        <div class="contact-wrap w-100" style="padding: 0px 48px">
                                                                            <div class="card2">
                                                                                <div class="card-body2">
                                                                                    ...
                                                                                    <h6 class="card-subtitle2">Latest Fee that created by Owner</h6>
                                                                                    <div class="row">
                                                                                ...
                                                                                <small style="font-style: italic; color: #EF3159">(*) You must pay after the deadline</small>
                                                                            </div>
                                                                                            ...
                                                                                            <c:forEach var="bl" items="${requestScope.billList}" varStatus="loop" >
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="d-flex justify-content-center gap-3">
                                                                                                        <a class="btn btn-info" style="text-decoration: none; color: #FFF" href="roombilldetail?id=${id}"><i class="fa-solid fa-circle-info"></i>&nbsp;Detail</a>
                                                                        ...
                                                                        <div class="row" style="margin-top:50px ">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group d-flex justify-content-center">
                                                                                    <a style="padding: 10px 20px; font-size: 18px" href="/HL_Motel/RenterHome.jsp" class="btn btn-danger"><i class="fa-solid fa-chevron-left"></i>&nbsp;Back To Home</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
