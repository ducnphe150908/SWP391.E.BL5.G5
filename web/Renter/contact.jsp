                    ...
                    <div class="row">
                        ...
                        <form action="request" method="POST">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <input type="text" name="title" class="form-control" placeholder="Write your title here (Max 50 characters)" maxlength="50" required>
                                </div>
                                <div class="col-12 mb-3">
                                    <textarea name="description" id="description" cols="30" rows="7" class="form-control" placeholder="Write your description here (Max 255 characters)" maxlength="255" required></textarea>
                                </div>
                                <div class="col-12 mb-3">
                                    <c:choose>
                                        <c:when test="${not empty sessionScope.user}">
                                            <input type="hidden" name="renterID" value="${sessionScope.user.userID}">
                                        </c:when>
                                        <c:otherwise>
                                            <input type="hidden" name="renterID" value="0"> <!-- Default value if user not logged in -->
                                        </c:otherwise>
                                    </c:choose>
                                    <input type="hidden" name="resStatus" value="Pending"> <!-- Example value, you can dynamically set it -->
                                </div>
                                <div class="col-12">
