<<<<<<< HEAD:web/Owner/Editnews.jsp

<%@page import="model.News"%>
=======
<%-- 
    Document   : Editslider
    Created on : Aug 21, 2024, 10:44:52 PM
    Author     : quanb
--%>
>>>>>>> 2c52a5981224332641a15ee4e61113ca4af79e4c:web/Owner/Editslider.jsp
            ...
            <div class="container my-5">
                ...
                <form action="UpdateSliderController" method="post" enctype="multipart/form-data">
                    <div class="form-group mb-3">
                        <label for="id">Slider ID</label>
                        <input type="text" name="id" value="${sliders.sliderId}" readonly/>
                </div>
                <div class="form-group mb-3">
                    <label for="title">Slider Name</label>
                    <input type="text" class="form-control" name="name" value="${sliders.sliderName}" required>
                </div>                
                <div class="form-group mb-3">
