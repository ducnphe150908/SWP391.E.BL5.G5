            ...
            <div class="main">
                <div class="container" style="margin-top: 2em">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="number" class="form-control" id="img-guide" placeholder="Enter score change" name="score" value="${rule.scoreChange}" required>
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="image-guideline" class="form-label">Penalty money </label>
                        <input type="number" class="form-control" id="img-guide" placeholder="Enter penalty money rule" name="penMoney" value="${rule.penMoney}" required>
                    </div>
