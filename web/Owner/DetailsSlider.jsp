<%-- 
    Document   : DetailsSlider
    Created on : Aug 21, 2024, 10:47:03 PM
    Author     : quanb
--%>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="product-cart-thumb row">
                                <div class="col-lg-6 col-12 mt-4 mt-lg-0">
                                    ...
                                    <button type="button" class="btn custom-btn cart-btn" onclick="location.href = 'formeditslider?id=${s.sliderId}'" style="margin-top: 10px">Edit News</button>
                                </div>
                                <p></br></p>
                            </div>
